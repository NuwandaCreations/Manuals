...
class GetQuotesUseCase {
    ...
    /*Se trata de una función que siempre que se cree una instancia de la clase GetQuotesUseCase se
    ejecutará directamente esta función sin necesidad de poner GetQuotesUseCase.mifunción()*/
